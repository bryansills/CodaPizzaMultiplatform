...
Assuming you have the tools to run an Android app, getting this app running on both platforms is relatively straightforward.
The Android app can be run using the standard Gradle tasks or the tooling within Android Studio.
In order to run the desktop JVM app, run the following Gradle command:
...
- [Coda Pizza Multiplatform](https://github.com/bryansills/CodaPizzaMultiplatform) (this project): A multiplatform pizza customizing app. Based on a project in the 5th edition of Big Nerd Ranch's Android guide (which I wrote), I wrote and presented this Kotlin multiplatform app as a codelab at KotlinConf 2023 in Amsterdam.
